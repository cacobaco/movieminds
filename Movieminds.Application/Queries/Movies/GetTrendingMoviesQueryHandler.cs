...
public class GetTrendingMoviesQueryHandler : ChainedRequestHandler<GetTrendingMoviesQuery, IPaginatedResponse<GetMovieResponse>>
{
    private readonly IUnitOfWorkAsync _unitOfWork;

    public GetTrendingMoviesQueryHandler(IUnitOfWorkAsync unitOfWork)
    {
